...
from joodu.model.global_interactor import GlobalInteractor
from joodu.model.local_encoder import LocalEncoder
from joodu.model.decoder import MLPDecoder
...
class TrajPredEncoderDecoder(pl.LightningModule):
    ...
    def __init__(self,
        ...
        # Save all fields explicitly as instance attributes
